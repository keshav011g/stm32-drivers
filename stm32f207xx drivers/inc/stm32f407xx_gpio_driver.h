...
//  GPIO_Init
typedef struct{
	uint32_t GPIO_PinNumber;			/* Possible values from @GPIO_PIN_NUMBER*/
	uint32_t GPIO_PinMode;			/* Possible values from @GPIO_PIN_MODES */
	uint32_t GPIO_PinSpeed;			/* Possible values from @GPIO_PIN_SPEED */
	uint32_t GPIO_PinPuPdControl;	/* Possible values from @GPIO_PIN_PuPdControl */
	uint32_t GPIO_PinOPType;			/* Possible values from @GPIO_PIN_OUTPUT */
